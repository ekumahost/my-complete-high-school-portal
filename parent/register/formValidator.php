...
}  else if ($type == 'web_parents_username') {
		if ($kas_framework->check_username_from_all($web_parents_username) == true) {
			print '<center><font color=red>this username is already taken</font></center>';
			$kas_framework->form_border_color('#web_parents_username', 'red');	
		} else {
			print '<center><font color=green>username is free</font></center>';
			$kas_framework->form_border_color('#web_parents_username', 'green');	
		}
}
