...
<html>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li class="click_ult"><a href="../"><i class="fa fa-home"></i> Home</a></li>
		...
		/* putting the form in a variable */
			$confirmation_form = '<form role="form" action="" method="get">
					<div class="box-body">
						<div class="form-group">
							<label for="exampleInputEmail1">Confirmation Code</label>
							<input type="text" required="required" class="form-control" name="cid" placeholder="Enter confirmation code">
						</div>
					</div>
				<div class="box-footer">
					...
					if (isset($_GET['cid'])) {
						$confirmation->ConfirmUser($_GET['cid']);
						echo '<h2>Students Confirmation Code</h2>';
