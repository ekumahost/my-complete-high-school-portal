	...
	<?php require (constant('double_return').'inc.files/sidebar.php') ?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        <i class="fa fa-sitemap text-ult_custom"></i> Demography<?php $student->display_accessLevel(); ?>
                    </h1>
                    <ol class="breadcrumb">
						<li class="click_ult"><a href="<?php print constant('single_return') ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
						<li class="active"><i class="fa fa-th-large"></i> Demography</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="ultimrap">
                            ...
                            <div class="small-box bg-paleyellow">
                                <div class="inner">
                                    <h2>
                                       <a href="attendance/"><font color='black'> Attendance </font></a>
                                    </h2>
                                    <p>
                                      <font color='black'> View Attendance</font>
                                    </p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa fa-ellipsis-h"></i>
                                </div>
                                <a href="attendance/" class="small-box-footer">
                        ...
                        <div class="ultimrap">
                            ...
                            <div class="small-box bg-green">
                                <div class="inner">
                                    <h2>
                                       <a href="health/"> <font color='white'>Health</font></a>
                                    </h2>
                                    <p>
                                        View Your Health Hisory
                                    </p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-plus-square"></i>
                                </div>
                                <a href="health/" class="small-box-footer">
                        ...
                        <div class="ultimrap">
                            ...
                            <div class="small-box bg-maroon">
                                <div class="inner">
                                    ...
                                    <p>
                                       View my Discipline Report
                                    </p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-meh-o"></i>
                                </div>
                                <a href="discipline/" class="small-box-footer">
                                    Open Application <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
						...
						<div class="small-box bg-red">
							...
							<a href="<?php print constant('single_return') ?>mytools/" class="small-box-footer"> Open Panel <i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div><!-- ./col -->
					</div><!-- /.row -->
