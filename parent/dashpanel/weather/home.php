	...
	<?php require (constant('double_return').'inc.files/parentsidebar.php') ?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                      <i class="fa fa-cloud"></i> Weather Update
                        <small>cloud reading</small>
                    </h1>
                    <ol class="breadcrumb">
        ...
        <script src="<?php print constant('tripple_return') ?>js/AdminLTE/dashboard.js" type="text/javascript"></script>     
