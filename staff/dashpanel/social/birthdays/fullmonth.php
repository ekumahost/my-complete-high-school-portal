	...
	<!-- Right side column. Contains the navbar and content of the page -->
		<aside class="right-side">
			...
			<section class="content-header">
				<h1> <i class="fa fa-gift"></i> Birthday | <?php print $kas_framework->int_to_month($month); $staff->display_accessLevel(); ?> </h1>
				<ol class="breadcrumb">
					<li class="click_ult"><a href="<?php print constant('single_return') ?>"><i class="fa fa-windows"></i>Social</a></li>
					<li class="click_ult"><a href="<?php print constant('single_return') ?>birthdays/"><i class="fa fa-gift"></i>Today</a></li>
