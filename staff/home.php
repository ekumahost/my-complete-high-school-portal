...
.bg-black {background: url(../img/user_bg.jpg) repeat center center fixed;
  ...
  background-size: cover;}
    ...
    <body class="bg-black">
		...
		<div class="header"> <a href="../"><?php $kas_framework->displaySchoolLogo('60', 'circle', '0 5px 0 -10px'); ?></a>Staff Check In</div>
		...
		<?php if ($kas_framework->app_config_setting('staff_login') == false) {
			$kas_framework->showDangerCallout('<font color="black"><center> Sorry! Staff Login has been closed. See the School Administrator for this.  But Teranig have a question for you... How did you get here? Your IP has been Logged. </font></center>
					...
					require (constant('single_return').'php.files/classes/mailing_list.php');
						...
						<br />Destination: Staff Portal. <br />Location: Login. <br />User IP: '.$kas_framework->getUserIP().'<br />Please Respond.');
			...
			<form action="" method="post" id="loginForm">
                <div class="body bg-gray">
					...
					Username or Email
                        <input type="text" required="required" name="username" class="form-control" placeholder="Username or Email Address"/>
                    </div>
                    <div class="form-group">
					Password
                ...
                <div class="footer" align="center">                                                               
                    ...
                    <p><a href="resetpwd">Forgot my password</a> &laquo; &raquo; <a href="../" class="text-center">Navigate Away</a></p>
                    </form>
                     <br />
		...
		$('#signin').click(function(e) {
			...
			$.post('../php.files/staff_login_script', loginVals, function(data) {
