		...
		<?php require (constant('double_return').'inc.files/sidebar.php') ?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        <i class="fa fa-smile-o"></i> Manage Students Discipline
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="<?php print constant('single_return') ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
                        <li class="active"><i class="fa fa-smile-o"></i>&nbsp;&nbsp;Discipline</li>
                    </ol>
                </section>
			...
			<?php
				if ($staff_discipline == '0') {
					print ($kas_framework->showDangerCallout('You dont Have the Priviledge to Manage the The Discipline of the Whole Students. Tell the Admin to grant you the Priviledge.
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">All Students (Misbehaviours <i class="fa fa-smile-o"></i>)</h3>                                    
                                </div><!-- /.box-header -->
                                       ...
                                       <thead>
                                        ...
                                        <tbody>
                                            <?php
												...
												*/
												$viewStdList->viewStdList($db_parameter, $xtraAttd=false, $xtraDis=true);
												$db_parameter = null;
											?>
										</tbody>
									</table>
