...
require (constant('double_return').'php.files/prospectStudent_details.php');
require (constant('double_return').'php.files/classes/prospectStudent.php'); 

/*	require ('../inc.files/cookieWriter.php');*/
 ?>
<!DOCTYPE html>
<html>
    <head>
	...
	<?php require (constant('single_return').'inc.files/sidebar.php') ?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-dashboard text-green"></i> Students Dashboard  </h1>
                    <ol class="breadcrumb">
				  ...
				  <div class="row">
					...
					<div class="ultimrap">
                            ...
                            <div class="small-box bg-yellow">
                                ...
                                <a href="results/" class="small-box-footer click_ult">Open Help <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div><!-- ./col -->
                        <div class="ultimrap">
                            <!-- small box -->
                            <div class="small-box bg-red">
                                ...
                                <a href="weather/" class="small-box-footer click_ult"> Open Help <i class="fa fa-arrow-circle-right"></i> </a>
                            </div>
                        </div><!-- ./col -->
						<div class="ultimrap">
                            <!-- small box -->
                            <div class="small-box bg-navy">
                                ...
                                <a href="mailbox/" class="small-box-footer click_ult">Open Mailbox <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div><!-- ./col -->
						<div class="ultimrap">
                            <!-- small box -->
                            <div class="small-box bg-maroon">
                                <div class="inner">
                                    <h2> Photo Card</h2>
                                    <p>Print your Photo Card </p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-picture-o"></i>
                                </div>
                                <a href="photocard/" class="small-box-footer click_ult"> Open Panel <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div><!-- ./col -->
                    </div><!-- /.row -->
        ...
        <script src="<?php print constant('double_return') ?>js/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
         <!-- Bootstrap WYSIHTML5 -->
        <script src="<?php print constant('double_return') ?>js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script>
		<!-- FancyBox -->
		<script src="<?php print constant('double_return') ?>fancybox/jquery.fancybox.js" type="text/javascript"></script>
		<script src="<?php print constant('double_return') ?>fancybox/media_helper.js" type="text/javascript"></script>
        <!-- AdminLTE App -->
