...
<head>
	...
	<link href="<?php print constant('tripple_return') ?>css/iCheck/minimal/blue.css" rel="stylesheet" type="text/css" />
	<!-- Theme style -->
...
<?php require (constant('double_return').'inc.files/sidebar.php') ?>
	...
	<aside class="right-side">
		...
		<section class="content-header">
			<h1><i class="fa fa-envelope"></i> Mailbox </h1>
			<ol class="breadcrumb">
		...
		<?php $prospectStudent->check_profile_completeness($completeness); //$student->checkBasicPlan(); ?>
