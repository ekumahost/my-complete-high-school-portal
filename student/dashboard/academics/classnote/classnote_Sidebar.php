			...
			<?php $kas_framework->showInfoCallout('<b>Note:</b> Select other Sessions and Term Homework'); ?>
					<form role="form" action="../classnote/" method="post" id="addEventForm">
						<div class="box-body">
							<div class="form-group">
								<label for="color">Pick Session: </label>
									<select name="school_years"> <option value="%%">All</option>
									<?php $kas_framework->getDistinctField('classnote', 'session', 'grade', '%%', 'school_years', 'school_years_desc', 'school_years_id', $dyn_grade_year) ?>
								</select>
							...
							<div class="form-group">
								<label for="color">Grade Year: </label>
									...
									<?php $kas_framework->getDistinctField('classnote', 'grade', 'grade', '%%', 'grades', 'grades_desc', 'grades_id', $dyn_grade) ?>
								</select>
								<input type="hidden" name="byepass" value="gyj4Cynolg3Vvrc4JTYtd" />
							</div>
							<div class="form-group">
								<label for="color">Which Term? </label>
									...
									<?php $kas_framework->getDistinctField('classnote', 'term', 'grade', '%%', 'grade_terms', 'grade_terms_desc', 'grade_terms_id', $dyn_grade_history_term) ?>
									</select>
								<input type="hidden" name="byepass" value="gyj4Cynolg3Vvrc4JTYtd" />
							</div>
						</div><!-- /.box-body -->
