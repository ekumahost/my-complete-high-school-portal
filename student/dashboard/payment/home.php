                    ...
                    <div class="row">
						<div class="ultimrap">
                            ...
                            <div class="small-box bg-maroon">
                                ...
                                <a href="schoolfees/" class="small-box-footer click_ult">
                        ...
                        <div class="ultimrap">
                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    ...
                                    <p>
                                        pay your hostel fees
									</p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-credit-card"></i>
                                </div>
                                <a href="hostel/" class="small-box-footer click_ult">
						 ...
						 <div class="ultimrap">
                            ...
                            <div class="small-box bg-red">
                                <div class="inner">
                                    ...
                                    <p>
                                       Buy your things here
									</p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-shopping-cart"></i>
                                </div>
                                <a href="shop/" class="small-box-footer click_ult">
                                    Open Aplication <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
						<div class="ultimrap">
                            ...
                            <div class="small-box bg-navy">
                                <div class="inner">
                                    <h2>
                                       <font color='white'>My Tools</font>
                                    </h2>
                                    <p>
                                       <font color='white'>Visit your Tool Menu</font>
									</p>
                                </div>
                                <div class="icon">
                                    <i class="fa fa-th-large"></i>
                                </div>
                                <a href="<?php print constant('single_return') ?>mytools/" class="small-box-footer click_ult">
