		...
		<?php require (constant('double_return').'inc.files/sidebar.php') ?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        <i class="fa fa-list-alt text-yellow"></i> Manage Students Attendance
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">All Students (Mark Attendance <i class="fa fa-list-alt"></i>) </h3>                                    
                                </div><!-- /.box-header -->
										...
										<?php
											...
											*/
											$parameter = "SELECT * FROM studentbio WHERE studentbio_school = '".$staff_school."' AND admit = '1'";
												...
												*/												
												$viewStdList->viewStdList($db_parameter, $xtraAttd=true, $xtraDis=false);
												$db_parameter = null;
										?>
										</tbody>
									</table>
