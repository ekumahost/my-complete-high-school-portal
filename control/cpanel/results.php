...
<div class="container-fluid">
	...
	<div class="row-fluid">
	 ...
	 <a id="console"></a>
		<div id='actiontitle' align='left' style="margin-left:10px">
		  <h2>School Result/Report Cards Management </h2>
		</div>
	...
	<?php include("tools/get_result_url.php")?>
