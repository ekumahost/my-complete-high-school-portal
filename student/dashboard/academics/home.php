	...
	<?php require (constant('double_return'). 'inc.files/sidebar.php') ?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        <i class="fa fa-dot-circle-o text-fuchsia"></i> Academics <?php $student->display_accessLevel(); ?>  </h1>
                    <ol class="breadcrumb">
						<li class="click_ult"><a href="<?php print constant('single_return') ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
						<li class="active"><i class="fa fa-dot-circle-o"></i> Academics</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="ultimrap">
                            ...
                            <div class="small-box bg-maroon">
                                <div class="inner">
                                    <h2>
                                       <a href="schooltimetable/"><font color='white'> Lecture Timetable</font></a>
                                    </h2>
                                    <p>
                                      <font color='white'> View your School Timetable</font>
                                    </p>
                                </div>
                                <div class="icon">
                                ...
                                <a href="schooltimetable/" class="small-box-footer click_ult">
                                   <font color='white'> Open Content </font><i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
						<div class="ultimrap">
                            ...
                            <div class="small-box bg-red">
                                <div class="inner">
                                    <h2>
                                       <a href="homework/"> <font color='white'>HomeWork</font></a>
                                    </h2>
                                    <p>
                                ...
                                <a href="homework/" class="small-box-footer click_ult">
                                    Open Content <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
						<div class="ultimrap">
                            ...
                            <div class="small-box bg-fuchsia">
                                <div class="inner">
                                    <h2>
                                       <a href="library/"> <font color='white'>School Library</font></a>
                                    </h2>
                                    <p>
                                ...
                                <a href="library/" class="small-box-footer click_ult">
                                    Open Content <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
						<div class="ultimrap">
                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    <h2>
                                       <font color='white'>Class Note</font>
                                    </h2>
                                    <p>
                                       <font color='white'>Download your Classnotes</font>
									</p>
                                </div>
                                <div class="icon">
