	   ...
	   <?php require (constant('double_return').'inc.files/sidebar.php') ?>
		...
		<aside class="right-side">
			...
			<section class="content-header">
				<h1><i class="fa fa-cogs"></i> My Profile </h1>
				<ol class="breadcrumb">
					...
					<div class="box box-primary">
						...
						<form role="form">
							...
							<table width="100%" border="0" cellpadding="4">
							  ...
							  <tr><td><b>Surname</b> <i class="fa fa-hand-o-right"></i></td><td><?php print $userfirstname; ?></td></tr>
							  <tr><td><b>Lastname</b> <i class="fa fa-hand-o-right"></i></td><td><?php print $userlastname; ?></td></tr>
