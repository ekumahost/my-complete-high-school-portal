                ...
                <section class="content">
                  ...
                  <?php $email_input_form = '<div class="error-page">
					...
					<form role="form" action="" method="post">
							<div class="box-body">
								<div class="form-group">
									...
									<input type="password" class="form-control" name="password1" id="password1" placeholder="Enter New Password" required />
								</div>
								<div class="form-group">
					...
					if (isset($_GET['code']) and isset($_GET['email'])) {
						...
						if ($confirmation->confirm_reset_student($decode_email, $pwd_code) == true) {
							$querySQL = "SELECT * FROM web_students WHERE email = '".$decode_email."' AND pass = '".$pwd_code."' LIMIT 1";
						...
						$users_username = $paramGetFields->user_n;
							...
							(isset($_POST['reset_pwd_final']))? $confirmation->change_password_student($decode_email, $pwd_code): '';
					...
					//////////////////////// if not the form, display the email form ///////////////	
						...
						(isset($_POST['send_link_butt']))? $confirmation->confirm_email_send_link_student($_POST['username']): '';
						echo $email_input_form;
					}
