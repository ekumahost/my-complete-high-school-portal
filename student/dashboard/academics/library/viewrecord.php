...
<html>
    ...
    <body class="skin-blue">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="click_ult"><a href="<?php print constant('single_return') ?>library/"><i class="fa fa-desktop"></i>Library</a></li>
		...
		<center><p style="font-size:15px; margin:0 0 12px 8px; width:80%"> 
			<a href="<?php print constant('single_return') ?>library/"><button class="btn btn-default btn-block">
