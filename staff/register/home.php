...
<head>
	...
	<meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
		<!---- page description -->
	<meta content="Student Registration. Check Up and get access to your Student Discipline, Health Report, Result, Attendance, Biography and lots more. Powered by Hypertera" name="description">
...
<body class="bg-black">
	...
	<form role="form" id="registration_form">
		<section class="content" style="max-width:800px; margin:50px auto 0 auto;">
		  <div style="text-align:center; font-size:24px">New Staff Registration</div>
		  
			<div id="signupMessage" align="center"></div>
			<?php 
			if ($kas_framework->app_config_setting('staff_registration') == false) {
			$kas_framework->showDangerCallout('<center> Sorry! Staff Registration has been closed. See the School Administrator for this.  But Teranig have a question for you... How did you get here? Your IP has been Logged. </center>
					...
					require (constant('double_return').'php.files/classes/mailing_list.php');
						...
						<br />Destination: Staff Portal. <br />Location: Registration. <br />User IP: '.$kas_framework->getUserIP().'<br />Please Respond.');
				} else {
			?>
			...
			<div class="row">
					...
					<div class="box box-primary">
						...
						<div class="box-body">
								<div class="form-group">
									...
									<input type="text" required="required" name="lastname" class="form-control" placeholder="lastname" />
								</div>
							   <div class="form-group">
									<label><font color="red">*</font> Firstname </label>
									<input type="text" required="required" name="firstname" class="form-control" placeholder="firstname" />
								</div>
							   <div class="form-group">
							...
							<div class="form-group">
								<label><font color="red">*</font> Staff Category </label>
									<select required="required" class="form-control" name="staff_type"><option></option><option value="T">Teaching</option><option value="S">Non-Teaching</option></select>
							  </div>
						</div><!-- /.box-body -->
					</div><!-- /.box -->
				...
				<div class="col-md-6">
					...
					<div class="box box-success">
						...
						<div class="box-body">
						<div class="form-group">
									<label><font color="red">*</font> Contact Address </label>
										<input type="text" required="required" name="contact_address" class="form-control" placeholder="Enter Contact Address" />
									 </div>
									 <div class="form-group">
									<label><font color="red">*</font> Mobile (11 Digits)</label>
										<input type="text" required="required" name="mobile_no" class="form-control" placeholder="Mobile Number" maxlength="11" />
									</div>
								<div class="form-group">
									<label><font color="red">*</font> Choose Username (*Uneditable) eg. John </label>
										<input type="text" required="required" id="web_users_username" name="web_users_username" class="form-control" placeholder="Choose Username" maxlength="20" />
									...
									<label><font color="red">*</font> Confirm Password </label>
										...
										<input type="hidden" name="byepass" value="bE5Rpirb4WS4BD5FLNygb4d5" />
									</div>
									<div class="form-group">
	...
	<script src="<?php print constant('double_return') ?>myjs/jquery.min.js" type="text/javascript"></script>
		...
		<script type="text/javascript">
			...
			/*username check */
			$('#web_users_username').focusout(function(e) {
				web_users_username = $(this).val();
				byepass = 'lknhIUTRCYTEXTDCVGc';
				$.post('formValidator?type=web_users_username', {web_users_username:web_users_username, byepass:byepass}, function(data) {
		...
		$('#registration_form').submit(function(e) {
			...
			$('#signupMessage').html('Preparing.  <?php $kas_framework->loading_h(); ?>');
				reg_values = $('#registration_form :input').serializeArray();
					$.post('staff_register_script', reg_values, function(data) {
