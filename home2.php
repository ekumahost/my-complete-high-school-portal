...
<html>
	...
	<body>
		...
		<div class="content">
			...
			<ul id="tiles" style="align:center">
				...
				<li onClick="location.href='#';">
			        	...
			        	<div class="post-info">
			        		<div class="post-basic-info">
				        		<h3>Demo Order</h3>
								<span><a href="../demo+order?order_category=admin&order_code=<?php print $kas_framework->generateRandomString(20) ?>"><label> </label><strong>Admin Demo Order</strong></a></span><br>
                                <span><a href="../demo+order?order_category=student&order_code=<?php print $kas_framework->generateRandomString(20) ?>"><label> </label>Student Demo Order</a></span><br> 
								<span><a href="../demo+order?order_category=staff&order_code=<?php print $kas_framework->generateRandomString(20) ?>"><label> </label>Staff Demo Order</a></span><br>
								<span><a href="../demo+order?order_category=parent&order_code=<?php print $kas_framework->generateRandomString(20) ?>"><label> </label><strong>Parent Demo Order</strong></a></span>

				        		<p>Select and Order a demonstration</p>
			        		</div>
			        	</div>
			        </li>
