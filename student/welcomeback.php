...
//the page for the proper login		
	if (@$_GET['ref'] == 'newuser') {
			$kas_framework->setCookie('hold_username', '', 30);
			$kas_framework->setCookie('hold_image', '', 30);
			print '<script type="text/javascript">self.location = "'.$kas_framework->server_root_dir('student').'" </script>';
	}
	...
	$held_image = $kas_framework->getCookie('hold_image');
	$username = $kas_framework->getCookie('hold_username');
?>
<!DOCTYPE html>
    ...
    <body>
       ...
       <!-- jQuery 2.0.2 -->
		...
		$('#signin').click(function(e) {
			...
			$.post('../php.files/student_login_script', {username:username, password:password, byepass:byepass}, function(data) {
