...
<html>
 ...
 <!-- Right side column. Contains the navbar and content of the page -->
			...
			<div class="row"> 
			<?php
			$email_address = $student_parents_email;
				$fullname = $kas_framework->getValue('title_desc', 'tbl_titles', 'title_id', $student_parents_title).' '.$student_parents_lastname.' '.$student_parents_firstname;
			?>
				<div class="col-md-12">
					<!-- The time line -->
					<ul class="discussion">
