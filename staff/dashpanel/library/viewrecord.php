...
<html>
		...
		<?php require (constant('double_return').'inc.files/sidebar.php') ?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1><i class="fa fa-desktop"></i> Library | My Record <?php $staff->display_accessLevel(); ?> </h1>
                    <ol class="breadcrumb">
						<li class="click_ult"><a href="<?php print constant('single_return') ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
						<li class="click_ult"><a href="<?php print constant('tripple_return') ?>library/"><i class="fa fa-desktop"></i>Library</a></li>
	...
	<center><p style="font-size:15px; margin:0 0 12px 8px; width:80%"> 
			<a href="<?php print constant('tripple_return') ?>staff/dashpanel/library/"><button class="btn btn-default btn-block">
                                        ...
                                        <tbody>
                                            <?php  
												$library = "SELECT * FROM media_history WHERE media_history_borrower_type = 'stf'
													AND media_history_borrower = '".$web_users_relid."'
													AND media_history_school = '".$staff_school."'										
